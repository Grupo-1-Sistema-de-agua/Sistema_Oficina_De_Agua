    ...
    <div class="col-lg-8">
      <div class="card shadow-sm">
        <div class="card-header bg-white">
          <h2 class="h5 mb-0">Editar Cliente</h2>
        </div>
        <div class="card-body">
          <form action="<?= base_url('clientes/update/' . $cliente['id']) ?>" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nombre" name="nombre"
                     value="<?= esc_nativo($cliente['nombre']) ?>" required maxlength="150">
            </div>

            <div class="mb-3">
              <label class="form-label" for="dpi">DPI</label>
              <input type="text" class="form-control" id="dpi" name="dpi"
                     value="<?= esc_nativo($cliente['dpi'] ?? '') ?>" required minlength="13" maxlength="13"
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="telefono" name="telefono"
                     value="<?= esc_nativo($cliente['telefono'] ?? '') ?>" maxlength="20">
            </div>
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control" id="direccion_principal" name="direccion_principal"
                     value="<?= esc_nativo($cliente['direccion_principal']) ?>" required maxlength="255">
            </div>
